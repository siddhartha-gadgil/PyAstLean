...
# CHECK: throw (PastaLean.PyException.Raise "ValueError"
# CHECK: ToString.toString "negative")
# CHECK: return
# CHECK: String.append
# CHECK: PastaLean.PyExcept _)
...
# CHECK: x := helper x
# CHECK: throw (PastaLean.PyException.Raise "Exception"
...
# CHECK: throw (PastaLean.PyException.Raise "ValueError"
# CHECK: throw (PastaLean.PyException.Raise "ZeroDivisionError"
...
# CHECK: for i in PastaLean.pyRange num do
# CHECK: if (caught).OfKind == "ValueError" then
