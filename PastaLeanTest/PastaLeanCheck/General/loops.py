...
# CHECK: for i in PastaLean.pyRange n do
# CHECK: for j in PastaLean.pyRange i do
...
# CHECK: for i in PastaLean.pyRange n do
# CHECK: for j in PastaLean.pyRange n do
# CHECK: for k in PastaLean.pyRange n do
# CHECK: for l in PastaLean.pyRange n do
