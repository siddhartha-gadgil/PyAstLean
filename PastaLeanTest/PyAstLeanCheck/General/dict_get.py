...
# CHECK: let found := PastaLean.pyGetOpt d "apple"
# CHECK: let missing := PastaLean.pyGetOpt d "pear"
# CHECK: let fallback := PastaLean.pyGetD d "pear" (999 : Int)
# CHECK: (found, (missing, fallback))
# CHECK: def dict_get_len_mix :=
# CHECK: let d := Std.HashMap.ofList
# CHECK: let got := PastaLean.pyGetD d "x" (0 : Int)
